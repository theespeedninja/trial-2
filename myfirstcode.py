...
div=a/b
multiplication=a*b
print("Here are the results of the arithmetics")
print(f"Sum is:_{sum}")
print(f"Difference is:_{diff}")
print(f"multiplication is:_{multiplication}")
print(f"divison is:_{div}")
"""
